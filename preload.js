...
window.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById("calculate_percentage").addEventListener('click', calculate_percentage);
  document.getElementById("clear_entry").addEventListener('click', clear_entry);
  document.getElementById("button_clear").addEventListener('click', button_clear);
  document.getElementById("backspace_btn").addEventListener('click', backspace_remove);

  document.getElementById("division_one").addEventListener('click', division_one);
  document.getElementById("power_of").addEventListener('click', power_of);
  document.getElementById("square_root").addEventListener('click', square_root);
  document.getElementById("plusOp").addEventListener('click', () => button_number('+'));

  document.getElementById("button_7").addEventListener('click', () => button_number(7));
  document.getElementById("button_8").addEventListener('click', () => button_number(8));
  document.getElementById("button_9").addEventListener('click', () => button_number(9));
  document.getElementById("subOp").addEventListener('click', () => button_number('-'));

  document.getElementById("button_4").addEventListener('click', () => button_number(4));
  document.getElementById("button_5").addEventListener('click', () => button_number(5));
  document.getElementById("button_6").addEventListener('click', () => button_number(6));
  document.getElementById("multiOp").addEventListener('click', () => button_number('*'));

  document.getElementById("button_1").addEventListener('click', () => button_number(1));
  document.getElementById("button_2").addEventListener('click', () => button_number(2));
  document.getElementById("button_3").addEventListener('click', () => button_number(3));
  document.getElementById("divOp").addEventListener('click', () => button_number('/'));

  document.getElementById("plus_minus").addEventListener('click', plus_minus);
  document.getElementById("button_0").addEventListener('click', () => button_number(0));
  document.getElementById("dot").addEventListener('click', () => button_number('.'));
  document.getElementById("equal_sign").addEventListener('click', () => button_number('='));
